...
function Apply() {
  return (
    <div className='flex flex-col justify-center items-center px-8 md:px-32 pb-10 gap-14 md:gap-32 pointer-events-none relative'>
        <p className='text-3xl md:text-5xl font-semibold text-[#EEE5FF] text-center md:leading-[5rem] md:w-[55%]'>Apply On Any Section Or Enable For Whole Page</p>
