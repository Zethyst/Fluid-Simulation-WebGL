...
function Ratings() {
  return (
    <div className='flex flex-col justify-center items-center px-32 pb-10 gap-20 pointer-events-none relative'>
        <p className='text-2xl font-semibold text-gray-200 sora'>Trusted by thousands of users around the world</p>
        <div className='w-full flex justify-center items-center gap-64 text-gray-400 sora'>
