...
function Plugin() {
  return (
    <div className='flex flex-col justify-center items-center px-5 md:px-32 p-16 gap-5 pointer-events-none relative'>
            <p className='text-3xl md:text-5xl font-medium text-[#EEE5FF] text-center leading-[5rem] md:w-[55%] sora'>An All-Round Plugin With Powerful Features</p>
